  ...
  return (
    <nav className="topbar">
      ...
      <div className="topbar-right">
        <Link to={user?.role === 'Employee' ? '/employee/profile' : '/profile'} className="topbar-avatar" style={{ textDecoration: 'none', cursor: 'pointer', fontSize: '14px', background: '#e2e8f0', padding: '5px 10px', borderRadius: '5px' }}>Profile</Link>
